...
Func _Login($times = 0)
	While 1
		...
		$login = _HttpRequest(4, 'http://ftugate.ftu.edu.vn/default.aspx?page=dangnhap', $data_login, $cookie, '', 'Upgrade-Insecure-Requests: 1')
		If @error Then
...
Func _Alert()
	...
	While 1
		$dkmh = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/Default.aspx?page=dkmonhoc', '', $cookie)
		If StringInStr($dkmh, 'Ngoài thời gian đăng ký') > 50 Then
			ContinueLoop
