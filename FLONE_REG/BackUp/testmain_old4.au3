	...
	While 1
		...
		Else
			...
			#cs ElseIf (StringInStr($login[1], "ctl00_Header1_ucLogout_lblNguoiDung") > 0) Then
				...
				Return True
			#ce
			Else $login = _HttpRequest(4, 'http://ftugate.ftu.edu.vn/', '', $cookie, '', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:78.0) Gecko/20100101 Firefox/78.0|DNT: 1|Connection: keep-alive|Upgrade-Insecure-Requests: 1'))
