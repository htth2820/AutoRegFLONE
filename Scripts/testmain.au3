...
Cần làm:
	...
	+) Sửa lọc để, thay [0] sau stringreg bằng 1 biến riêng ra để If @error được, tránh trường hợp tool tự đóng bất thường
	+) Tu luu dang ky khi 1 mon bi loi stringregexp
	+) Thêm tính năng tự động đăng ký phương án dự phòng
	+) Check slot trước khi hủy để chuyển lớp
	+) Nếu login thất bại lần 1 thì lần 2 sẽ lôi ra lỗix
	+) Bị logout vẫn báo mã lớp/mã nguồn có vde
	+) $ten khi tieng Anh
...
While 1
	...
	Switch $nMsg
		...
		Case $List
			...
			If $sub_data[2] = '' Then
				$Show_dsdk = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', '{}', $cookie, '', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: ShowDSDaDangKy')
				...
				;EndIf
			Else
				$kqloc = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', '{"dkLoc":' & '"' & $sub_data[2] & '"' & '}', $cookie, 'http://ftugate.ftu.edu.vn/Default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: LocTheoMonHoc')
		...
		Case $Reg_plan
			...
			Else
				...
				For $i = 1 To _FileCountLines($file)
					...
					_Reg()
				Next
				$check_trung = _HttpRequest(0, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', '{}', $cookie, 'http://ftugate.ftu.edu.vn/default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: KiemTraTrungNhom')
				$luu = _HttpRequest(0, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', '{}', $cookie, 'http://ftugate.ftu.edu.vn/default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: LuuDanhSachDangKy')
				$luu_hople = _HttpRequest(0, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', '{"isCheckSongHanh":false,"ChiaHP":false}', $cookie, 'http://ftugate.ftu.edu.vn/default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: LuuDanhSachDangKy_HopLe')
				$Show_dsdk = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', '{}', $cookie, '', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: ShowDSDaDangKy')
				FileDelete(@ScriptDir & '\Show.html')
				FileWrite(@ScriptDir & '\Show.html', $Show_dsdk)
				ShellExecute(@ScriptDir & '\Show.html')
		...
		Case $Clear
			...
			Else
				...
				For $i = 1 To _FileCountLines($file_del)
					...
					_Del()
				Next
				_HttpRequest(0, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', '{}', $cookie, 'http://ftugate.ftu.edu.vn/default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: KiemTraTrungNhom')
				_HttpRequest(0, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', '{}', $cookie, 'http://ftugate.ftu.edu.vn/default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: LuuDanhSachDangKy')
				$end = _HttpRequest(0, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', '{"isCheckSongHanh":false,"ChiaHP":false}', $cookie, 'http://ftugate.ftu.edu.vn/default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: LuuDanhSachDangKy_HopLe')
...
Func _Captcha()
	...
	Local $source = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/', '', $cookie, '', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|Upgrade-Insecure-Requests: 1')
	$capt = StringRegExp($source, '(.*?)', 1)[0]
	$source = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/', 'data2send', $cookie, '', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|Upgrade-Insecure-Requests: 1')
...
Func _Cookie()
	...
	Global $source_login = _HttpRequest(4, 'http://ftugate.ftu.edu.vn/', '', '', '', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|Upgrade-Insecure-Requests: 1')
...
Func _Login($times = 0)
	While 1
		...
		$login = _HttpRequest(0, 'http://ftugate.ftu.edu.vn/default.aspx', $data_login, $cookie, 'http://ftugate.ftu.edu.vn/default.aspx', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|Origin: http://ftugate.ftu.edu.vn|Origin: http://ftugate.ftu.edu.vn|DNT: 1|Connection: keep-alive|Upgrade-Insecure-Requests: 1')
		;		FileDelete(@ScriptDir & '\test1.html')
		;		FileWrite(@ScriptDir & '\test1.html', $login)
		;		ShellExecute(@ScriptDir & '\test1.html')
		$login = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/', '', $cookie, '', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|DNT: 1|Connection: keep-alive|Upgrade-Insecure-Requests: 1')
		#cs	If @error Then
		...
		#ce	If @error Then
		If StringInStr($login, "ctl00_Header1_Logout1_lblNguoiDung") Then
			If StringRegExp($login, 'font-weight:bold;">Chào bạn (.*?)</span>&nbsp', 0) = 1 Then
				...
				If $ten = '' Then
					...
					Else
						...
						_Text('Đang đăng nhập lại lần ' & $tlogin & '/3')
						ContinueLoop
					EndIf
				ElseIf $ten <> '' Then
...
;==============================_Load============================
Func _Load()
	$load_header = _HttpRequest(1, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', '{}', $cookie, 'http://ftugate.ftu.edu.vn/Default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: LoadDanhSachKhoaLop|DNT: 1')
...
Func _Reg()
	...
	If StringInStr($sub_data[2], 'GDTC') Then
		$fix = $sub_data[1] & ' ' & $sub_data[0]
	EndIf
	$kqloc = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', '{"dkLoc":' & '"' & $sub_data[1] & '"' & '}', $cookie, 'http://ftugate.ftu.edu.vn/Default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: LocTheoMonHoc')
		...
		Else
			...
			If $tach <> 0 Then
				...
				If $split_data[0] >= 13 Then
					...
					;$dkmh = _HttpRequest(0, 'http://ftugate.ftu.edu.vn/Default.aspx?page=dkmonhoc', '', $cookie, '', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36')
					...
					$reg = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', $data_reg, $cookie, 'http://ftugate.ftu.edu.vn/Default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: DangKySelectedChange')
					...
					If $return[0] > 30 Then
						If Number($return[10]) == 0 Then
							If (($return[7] = "") Or StringInStr($return[7], 'cần học trước')) And $return[8] == "" And $return[11] == "" Then
								...
								$check_luu = _HttpRequest(0, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', $data_reg, $cookie, 'http://ftugate.ftu.edu.vn/default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: LuuVaoKetQuaDangKy')
...
Func _Del()
	...
	$del = _HttpRequest(0, 'http://ftugate.ftu.edu.vn/ajaxpro/EduSoft.Web.UC.DangKyMonHoc,EduSoft.Web.ashx', $data_del, $cookie, 'http://ftugate.ftu.edu.vn/default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|X-AjaxPro-Method: XoaKQDKTheoMaDK')
...
;==============================_Logout==========================
Func _Logout()
	$source_logout = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/', '', $cookie, '', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|Upgrade-Insecure-Requests: 1')
	...
	$logout = _HttpRequest(1, 'http://ftugate.ftu.edu.vn/default.aspx?page=gioithieu', $data_logout, $cookie, '', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|Upgrade-Insecure-Requests: 1')

	If StringInStr($logout, 'http://ftugate.ftu.edu.vn/default.aspx') Then
		_Text('Đăng xuất thành công')
		_GUICtrlListView_DeleteAllItems($ListView1)
		GUICtrlSetData($BLogin, 'LOGIN')
		GUICtrlSetData($Account, '')
...
Func _Alert()
	...
	While 1
		...
		Else
			...
			EndIf
		EndIf
	Sleep(Random(25000, 70000, 1))
	WEnd
EndFunc   ;==>_Alert

#cs
	While 1
		$dkmh = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/Default.aspx?page=dkmonhoc', '', $cookie, '', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36')
...
;==============================_Schedule===========================
Func _Schedule()
	$get_sch = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/Default.aspx?page=thoikhoabieu&id=' & GUICtrlRead($Account), '', $cookie, 'http://ftugate.ftu.edu.vn/default.aspx?page=dkmonhoc', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|Upgrade-Insecure-Requests: 1')
	...
	Local $aFormSch = [['__EVENTTARGET', 'ctl00$ContentPlaceHolder1$ctl00$rad_ThuTiet'], ['__EVENTARGUMENT', ''], ['__LASTFOCUS', ''], ['__VIEWSTATE', $ViewStateSch], ['__VIEWSTATEGENERATOR', $ViewStateGenSch], ['ctl00$ContentPlaceHolder1$ctl00$ddlChonNHHK', '20201'], ['ctl00$ContentPlaceHolder1$ctl00$ddlLoai', '1'], ['ctl00$ContentPlaceHolder1$ctl00$rad_ThuTiet', 'rad_ThuTiet'], ['ctl00$ContentPlaceHolder1$ctl00$rad_MonHoc', 'rad_MonHoc']]
	$data2send = _HttpRequest_DataFormCreate($aFormSch)
	$post_sch = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/Default.aspx?page=thoikhoabieu&id=1711110303', $data2send, $cookie, '', 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Safari/537.36|DNT: 1|Host: ftugate.ftu.edu.vn|Origin: http://ftugate.ftu.edu.vn|Upgrade-Insecure-Requests: 1')
