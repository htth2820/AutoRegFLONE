...
Func _Schedule()
	...
	$get_sch1 = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/Default.aspx?page=thoikhoabieu', $data2send, $cookie, 'http://ftugate.ftu.edu.vn/Default.aspx?page=thoikhoabieu', 'Upgrade-Insecure-Requests: 1')
	...
	MsgBox(1,1,1)
	Local $aFormSch2 = [['__EVENTTARGET', 'ctl00$ContentPlaceHolder1$ctl00$ddlTuan'], ['__EVENTARGUMENT',''], ['__LASTFOCUS',''], ['__VIEWSTATE', $ViewStateSch], ['__VIEWSTATEGENERATOR', $ViewStateGenSch], ['__PREVIOUSPAGE', $PrePageSch], ['ctl00$ContentPlaceHolder1$ctl00$ddlChonNHHK', '20201'], ['ctl00$ContentPlaceHolder1$ctl00$ddlLoai', '0'], ['ctl00$ContentPlaceHolder1$ctl00$ddlTuan', 'Tuần 04 [Từ 07/09/2020 -- Đến 13/09/2020]']]
	$data2send = _HttpRequest_DataFormCreate($aFormSch2)
	$get_sch2 = _HttpRequest(2, 'http://ftugate.ftu.edu.vn/Default.aspx?page=thoikhoabieu', $data2send, $cookie, 'http://ftugate.ftu.edu.vn/Default.aspx?page=thoikhoabieu', 'Upgrade-Insecure-Requests: 1')
	FileDelete(@ScriptDir & '\tkb2.html')
	FileWrite(@ScriptDir & '\tkb2.html', $get_sch2)
	ShellExecute(@ScriptDir & '\tkb2.html')
EndFunc
